...
export default function WithSubnavigation() {
  ...
  const isSignUp = pathname === signUpPath;
  ...
  if (isSignUp || isHome) showSignUp = true;
    ...
    <Box>
      ...
      >
        ...
        <Stack
          ...
          paddingX={{ md: 2 }}
        >
          {showLogin && <NavButton text='Sign Up' path={signUpPath} />}
          {showSignUp && <NavButton text='Log In' path={loginPath} />}
          {isDashboard && <NavButton text='Sign Out' path={signOutPath} onClick={logout}/>}
          ...
          {isHome && (
            <Button
              ...
              fontWeight={600}
              color={"white"}
              bgGradient='linear(to-r, #04B6F8, #0BD4F9, #13F4FA)'
              href={"#"}
              _hover={{
                bg: "#13F4FA",
              }}
...
const NAV_ITEMS: Array<NavItem> = [
  {
    ...
    children: [
      ...
      {
        label: "Github",
        subLabel: "Source code for magpy",
        href: "#",
      },
    ],
  },
